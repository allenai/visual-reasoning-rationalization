text_only = {
    "train_data_file": "/data/vcr/annotations/train.jsonl",
    "output_dir": "/models/vcr/q_a_to_r/",
    "task": "vcr",
    "model_type": "gpt2_vcr",
    "model_name_or_path": "gpt2",
    "per_gpu_train_batch_size": 32,
    "per_gpu_eval_batch_size": 32,
    "eval_data_file": "/data/vcr/annotations/val.jsonl",
    "save_steps": 3000,
    "num_train_epochs": 5,
    "do_train": True,
    "learning_rate": 5e-5,
...
text_only_eval = {
    "model_type": "gpt2_vcr",
    "task": "vcr",
    "eval_data_file": "/data/vcr/annotations/val_random250.jsonl",
    "no_cache": True,
    "text_only": True,
    "embeddings_object_detector": False,
    "embeddings_situation_recognizer": False,
...
textual_situation = {
    "train_data_file": "/data/vcr/annotations/train_situation.jsonl",
    "output_dir": "/models/vcr/text_situation_q_a_to_r/",
    "task": "vcr",
    "model_type": "gpt2_vcr",
    "model_name_or_path": "gpt2",
    "per_gpu_train_batch_size": 32,
    "per_gpu_eval_batch_size": 32,
    "eval_data_file": "/data/vcr/annotations/val_situation.jsonl",
    "save_steps": 3000,
    "num_train_epochs": 5,
    "do_train": True,
    "learning_rate": 5e-5,
...
textual_situation_eval = {
    "model_type": "gpt2_vcr",
    "task": "vcr",
    "eval_data_file": "/data/vcr/annotations/val_random250_situation.jsonl",
    "no_cache": True,
    "text_only": False,
    "embeddings_object_detector": False,
    "embeddings_situation_recognizer": False,
...
embedding_situation = {
    "train_data_file": "/data/vcr/annotations/train.jsonl",
    "output_dir": "/models/vcr/embed_situ_q_a_to_r/",
    "task": "vcr",
    "model_type": "gpt2_vcr",
    "model_name_or_path": "gpt2",
    "per_gpu_train_batch_size": 32,
...
textual_objects = {
    "train_data_file": "/data/vcr/annotations/train.jsonl",
    "output_dir": "/models/vcr/text_objects_q_a_to_r/",
    "task": "vcr",
    "model_type": "gpt2_vcr",
    "model_name_or_path": "gpt2",
    "per_gpu_train_batch_size": 32,
...
embedding_objects = {
    "train_data_file": "/data/vcr/annotations/train.jsonl",
    "output_dir": "/models/vcr/embed_objects_q_a_to_r/",
    "task": "vcr",
    "model_type": "gpt2_vcr",
    "model_name_or_path": "gpt2",
    "per_gpu_train_batch_size": 32,
...
textual_viscomet = {
    "train_data_file": "/data/vcr/annotations/vcr_train_viscomet_inferences.json",
    #"train_data_file": "/data/vcr/annotations/vcr_val_viscomet_inferences_random250.jsonl",
    "output_dir": "/models/vcr/textual_viscomet_q_a_to_r/",
    "task": "vcr",
    "model_type": "gpt2_vcr",
    "model_name_or_path": "gpt2",
    "per_gpu_train_batch_size": 32,
    "per_gpu_eval_batch_size": 32,
    "eval_data_file": "/data/vcr/annotations/vcr_val_viscomet_inferences.json",
    #"eval_data_file": "/data/vcr/annotations/vcr_val_viscomet_inferences_random250.jsonl",
    "save_steps": 3000,
    "num_train_epochs": 5,
    "do_train": True,
    "learning_rate": 5e-5,
...
textual_viscomet_eval = {
    ...
    "task": "vcr",
    "eval_data_file": "/data/vcr/annotations/vcr_val_viscomet_inferences.json",
    #"eval_data_file": "/data/vcr/annotations/vcr_val_viscomet_inferences_random250.json",
    "no_cache": True,
    "text_only": True,
    "embeddings_object_detector": False,
    "embeddings_situation_recognizer": False,
...
embeddings_viscomet = {
    "train_data_file": "/data/vcr/annotations/vcr_train_viscomet_inferences.json",
    #"train_data_file": "/data/vcr/annotations/vcr_val_viscomet_inferences_random250.jsonl",
    "output_dir": "/models/vcr/embeddings_viscomet_q_a_to_r/",
    "task": "vcr",
    "model_type": "gpt2_vcr",
    "model_name_or_path": "gpt2",
    "per_gpu_train_batch_size": 32,
